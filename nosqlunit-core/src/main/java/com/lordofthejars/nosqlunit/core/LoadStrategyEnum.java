...
public enum LoadStrategyEnum {
	...
	INSERT(InsertLoadStrategyOperation.class), CLEAN_INSERT(CleanInsertLoadStrategyOperation.class), DELETE_ALL(DeleteAllLoadStrategyOperation.class), REFRESH(RefreshLoadStrategyOperation.class);
