...
public class DefaultInsertationStrategy implements MongoInsertationStrategy {

	private static Logger LOGGER = LoggerFactory.getLogger(DefaultInsertationStrategy.class);
